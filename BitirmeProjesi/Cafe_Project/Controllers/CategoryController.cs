...
namespace Cafe_Project.Controllers
{
    public class CategoryController : Controller
    {
        ...
        //Kategori kısmında cafe sayısını da anasayfa,kafeler ve kafe detay kısmında gösterecek 
        //birden fazla sayfada kullanacaklarımızı partial view ile yaparız
        public PartialViewResult _CategoryList()
        {
            var kategoriler = db.Categories.Select(x => new CategoryModel()
            {
               ...
               // oluşturduğumuz CategoryModel ile veritabanındaki kafeleri ilişkilendirdik
